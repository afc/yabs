...
/* although it's more R5-compitible
 * case is sensitive in R6 and R7 */

#ifndef bool
    enum {false, true}; /* assume they're undefined */
    typedef char bool;
    #define bool bool   /* accord as a macro */
#endif

typedef unsigned int uint;

#define SCHEME_VERSION "v2.2"
